...
Private Sub Command2_Click()
    ...
    Do
        ...
        S2 = "R=" & tRad & "  I=" & tSigma & "  S=" & tSigmaSpatial & "  IT=" & tIterations & "  C=" & tCONT & "|" & tLumHue & "  iMode=" & IntensityMode
        ...
        If PREVIEWmode Then
            ...
            PIC2.Refresh
            SaveJPG PIC2.Image, App.Path & "\OUT\EFForig" & S, 95
            FX.zSet_Source PIC2.Image.Handle
            FX.zEFF_BilateralFilter N, SigmaIntensity, SigmaSpatial, ITER, IntensityMode, IIf(chDirectional.Value = Checked, True, False)
            FX.zEFF_Contour Val(tCONT), Val(tLumHue)
            FX.zEFF_Contour_Apply
            FX.zGet_Effect PIC2.Image.Handle
            SaveJPG PIC2.Image, App.Path & "\OUT\EFFprev" & S, 95
            If chMakeCompare.Value = Checked Then
                ...
                End If
                SaveJPG PicIN.Image, App.Path & "\OUT\Compare_" & S, 95
            End If
        Else
            ...
            SaveJPG PIC1.Image, App.Path & "\OUT\" & S, 95
            '***********************************************************
